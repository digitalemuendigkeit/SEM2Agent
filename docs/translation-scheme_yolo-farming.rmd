...
description: |
  The full SEM2Agent scheme for the climate program in farming model.
author:
  - name: Lilian Kojan
date: "`r Sys.Date()`"
output: 
...
The secondary purpose is to examine the participation of farmers in a new climate policy program  dependent on their with such programs, their experience of experience of climate change and normative pressure.
...
The initial values are normalized so all scales reach from 0 to 1.
